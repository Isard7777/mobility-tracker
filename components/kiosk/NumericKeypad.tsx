    ...
    return (
        <div className="flex h-full w-full flex-col items-center justify-center gap-6 p-6">
            ...
            <button
                ...
                disabled={!isValid}
                onClick={onValidate}
                className="w-full max-w-xs rounded-2xl bg-emerald-600 py-4 text-2xl font-bold text-white shadow-lg transition active:scale-95 disabled:cursor-not-allowed disabled:bg-neutral-700 disabled:text-neutral-500"
            >
                Confirm
            </button>
        </div>
